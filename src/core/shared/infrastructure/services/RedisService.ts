...
{
  constructor(private readonly redisClient: RedisClientType, private readonly timeToExpire?: number) {}
  ...
  async set(entityToCache: EntityCache | EntityCache[], timeToExpire?: number): Promise<boolean> {
